...
export const mockEtfQuote: ETFQuote = {
  name: "半导体ETF",
  code: "159813",
  price: 1.73,
  change: -0.01,
...
export const mockMemoryPrices: MemoryPrice[] = [
  {
    name: "DRAM 合约价",
    period: "2026Q2",
    changePercent: 45,
...
export const mockFundFlow: FundFlow = {
  northBound: {
    today: -125000000,
...
export const mockUpdatedAt = "2026-05-30T14:32:18+08:00";
